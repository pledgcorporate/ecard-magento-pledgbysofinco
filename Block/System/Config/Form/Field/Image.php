...
class Image extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if (!(string)$element->getValue()) {
            $defaultImage = $this->getViewFileUrl('Pledg_PledgPaymentGateway::images/pledgbysofinco_logo.png');

            $html .= '<img src="' . $defaultImage . '" alt="PledgBySofinco logo" height="50" width="85" class="small-image-preview v-middle" />';
